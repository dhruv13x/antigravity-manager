...
from antigravity_manager.utils import build_archive_name, isoformat_local, safe_label
...
def test_build_archive_name():
    ...
    assert build_archive_name(dt, "user") == "2024-01-01-120000-user-antigravity.tar.gz"
